...
<div class="form-group row">
    <label for="IjasahPim" class="col-sm-6 col-form-label">	Ijazah PIM/PKP/PKA (PDF, max 2MB)</label>
    <div class="col-sm-6">
        <input type="file" class="form-control-file" id="IjasahPim" name="IjasahPim" accept=".pdf" max-size="2048000">
        <?= form_error('IjasahPim', '<small class="text-danger pl-3">', '</small>'); ?>
    </div>
</div>
<div class="form-group row">
